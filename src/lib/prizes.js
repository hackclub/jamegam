...
export const PRIZES = [
  ...
  { src: 'otamatone',       alt: 'Otamatone',              name: 'otamatone',              c: '#b991db', s: 96,  r: -12, fresh: true, lead: 'that’s an', opts: [{ key: 'color', label: 'color', choices: ['black', 'blue', 'white'] }], href: 'https://hamee.com/collections/otamatone', blurb: 'the famous singing synth' },
