...
export const PRIZES = [
  ...
  { src: 'camera',          alt: 'Kodak Charmera',         name: 'kodak charmera',         c: '#db9591', s: 106, r: 6,   blockCountries: ['india', 'pakistan'], href: 'https://www.kodak.retopro.co/products/kodak-charmera-br-keychain-digital-camera-blind-box', blurb: 'a keychain-sized digital camera from kodak! takes real photos' },
  ...
  { src: 'thumby',          alt: 'Thumby handheld',        name: 'thumby',                 c: '#97db91', s: 96,  r: -13, blockCountries: ['india', 'pakistan'], href: 'https://thumby.us/', blurb: 'a playable game console the size of your thumbnail, programmable in python' },
  ...
  { src: 'otamatone',       alt: 'Otamatone',              name: 'otamatone',              c: '#b991db', s: 96,  r: -12, lead: 'that’s an', opts: [{ key: 'color', label: 'color', choices: ['black', 'blue', 'white'] }], blockCountries: ['india', 'pakistan'], href: 'https://hamee.com/collections/otamatone', blurb: 'the famous singing synth' },
  ...
  { src: 'b_8bitdokb',   frame: 'scroll', alt: '8BitDo Retro Mechanical Keyboard', name: '8bitdo retro mechanical keyboard', c: '#b991db', bracket: true, blockCountries: ['india'], href: 'https://www.8bitdo.com/retro-mechanical-keyboard/', blurb: 'an nes mechanical keyboard' },
