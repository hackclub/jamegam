...
export const PRIZES = [
  ...
  { src: 'controller',      alt: '8BitDo controller',      name: '8bitdo controller',      c: '#97db91', s: 102, r: 12,  lead: 'that’s an', opts: [{ key: 'color', label: 'color', choices: ['green', 'mint', 'peach', 'purple', 'transparent black'] }], href: 'https://www.8bitdo.com/ultimate-2c-wireless-controller/', blurb: 'a nice wireless controller for pc and android, with hall effect sticks and triggers' },
