  ...
  const schema = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'Jame Gam - August 2026 game jam',
        description:
          "Jame Gam's monthly community jam. This August, teenage game devs build games together while taking part in the Brackeys Game Jam 2026.2. Free and online, open to ages 13 to 18, run by Hack Club.",
